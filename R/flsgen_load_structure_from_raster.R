...
#' Loads a landscape structure from an existing raster
#'
#' @description Loads a landscape structure from an existing raster
#'
...
#' @examples
#'   \dontrun{
#'     ls_struct <- flsgen_load_structure_from_raster(raster_path, c(0, 1, 2))
#'   }
#'
#' @export
flsgen_load_structure_from_raster <- function(raster_file, focal_classes, connectivity=4) {
