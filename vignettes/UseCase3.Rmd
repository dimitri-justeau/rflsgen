...
The second argument corresponds to the focal classes raster values (0 is open forest, and 1 closed forest), and for this use case we use the 8-connectivity rule.
